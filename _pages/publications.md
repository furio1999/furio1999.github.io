...
<body>
    <div class="container">
        <div class="image" align="center"><img src="../images/slides_cr.png" class="img-fluid" alt="Manuscript Thumbnail" style="max-width: 100%; max-height: 70px;"></div>
        ...
        <h6 class="fw-light"> <i> Fulvio Sanguigni, Mikolaj Czerkawski, Lorenzo Papa, Irene Amerini, Bertrand Le Saux </i> </h6><h6></h6>
        <h6></h6> <h6 class="fw-light"> Big Data from Space (BiDS), Nov 2023 </h6> <h6></h6>
