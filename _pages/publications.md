...
<body>
    <div class="container">
        ...
        <h6 style="font-weight: normal"> <i> Fulvio Sanguigni, Mikolaj Czerkawski, Lorenzo Papa, Irene Amerini, Bertrand Le Saux </i> </h6>
        <h6 style="font-weight: normal"> Big Data from Space (BiDS), Nov 2023 </h6>
        <br>
